...
function useVolumeListView(volumes: VolumeWithMedia[]) {
    ...
    const filteredVolumes = useMemo(() =>
            volumes.filter(v => matchesFilters(v, {searchCatalogNo, searchTitle, invertTitle, filterHasMedia})),
...
const MediaPage: React.FC = () => {
    ...
    const handleRowClick = useCallback(async (rowIndex: number) => {
        ...
        if (selectedRow !== null && editor.hasChanges()) {
            ...
            <div style={{display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 8}}>
                ...
                <HTMLSelect
                    ...
                    onChange={e => {
                        ...
                        setFilterHasMedia(v === NONE ? undefined : v === 'true')
                    }}
                    minimal
                    style={{width: 120}}
                >
            ...
            {loading ? (
                ...
                <div style={{flex: 1, minHeight: 0}}>
                    ...
                    <PopoverNext
                        ...
                        content={<Card style={{padding: 12, maxWidth: 600}}><MediaEditorContent {...editor} /></Card>}
